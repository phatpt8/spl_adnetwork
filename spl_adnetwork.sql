...
--
ALTER TABLE `banner`
MODIFY `BannerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `clickdetail`
--
ALTER TABLE `clickdetail`
MODIFY `ClickId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `impression`
--
ALTER TABLE `impression`
MODIFY `ImpId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `trueview`
--
ALTER TABLE `trueview`
MODIFY `TrueviewId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
